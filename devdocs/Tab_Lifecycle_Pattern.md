...
```html
<div class="tab-bar">
    <button class="tab-button active" data-tab="tab1">Viewer 1</button>
    <button class="tab-button" data-tab="tab2">Viewer 2</button>
    <button class="tab-button" data-tab="tab3">Viewer 3</button>
</div>
```
...
<div id="tab1-content" class="viewer-content">
    <h2>Viewer 1</h2>
    <!-- Viewer 1 UI elements -->
</div>

<!-- Viewer 2 Content (hidden initially) -->
<div id="tab2-content" class="viewer-content" style="display:none;">
    <h2>Viewer 2</h2>
    <!-- Viewer 2 UI elements -->
</div>

<!-- Viewer 3 Content (hidden initially) -->
<div id="tab3-content" class="viewer-content" style="display:none;">
    <h2>Viewer 3</h2>
    <!-- Viewer 3 UI elements -->
</div>
```
